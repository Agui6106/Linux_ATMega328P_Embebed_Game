...
custom_font = pygame.font.Font("./1945/imagine_font.ttf", 18)
white = (255,255,255)
light_grey = (191,191,191)
gold = (255,215,0)
          
# LOAD GRAPHICS
sprite_sheet_file = './1945/1945_sprite_sheet.png'
...
menu_graphic = './1945/menu.png'
water_bg = './1945/waterbgext.png'
...
# LOAD SOUNDS
fusion_snd = pygame.mixer.Sound('./1945/fusion.ogg')
shot_snd = pygame.mixer.Sound('./1945/shot.ogg')
thump_snd = pygame.mixer.Sound('./1945/thump.ogg')
cannon_snd = pygame.mixer.Sound('./1945/cannon.ogg')
start_snd = pygame.mixer.Sound('./1945/start.ogg')
pygame.mixer.music.load('./1945/music_1.ogg')
play_musc = 1
